...
class TestSelen(unittest.TestCase):
    ...
    def test_1(self):
        ...
        except NoSuchElementException: print("Error in first name input")
        try:
            input_second_name = driver.find_element(By.CSS_SELECTOR,
        ...
        try:
            input_mobile = driver.find_element(By.CSS_SELECTOR,
    ...
    def test_2(self):
        ...
        driver = webdriver.Chrome(
            executable_path=os.path.abspath(os.path.join(os.getcwd(), os.pardir, "chromedriver.exe")))
