...
# данный метод имеет область видимости в рамках текущего скрипта, чтобы распространить метод-fixture на все методы, нужно определить его в файле conftest.py
@pytest.fixture
def input_value():
    input = 39
    return input
